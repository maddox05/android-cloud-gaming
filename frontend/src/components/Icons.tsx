...
export function GiftIcon({ size = 20, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M20 12v10H4V12M22 7v5H2V7h20M12 22V7M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7zM12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
